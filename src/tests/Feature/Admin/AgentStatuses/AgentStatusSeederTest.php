...
class AgentStatusSeederTest extends TestCase
{
    ...
    public function test_seeder_is_idempotent_and_has_one_default(): void
    {
        $this->seed(AgentStatusSeeder::class);
        $this->seed(AgentStatusSeeder::class);
        $this->assertSame(9, AgentStatus::count());
        $this->assertSame(1, AgentStatus::active()->where('is_default', true)->count());
