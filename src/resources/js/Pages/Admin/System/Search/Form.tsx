...
export default function Form({
    ...
    const form = useForm<FormData>({
        ...
        infrastructure_connection_id:
            configuration?.infrastructure_connection_id ?? null,
        configuration: {},
    ...
    const requiresInfrastructure =
        selectedDefinition?.requires_infrastructure_connection ?? false
    ...
    const submit = (event: FormEvent<HTMLFormElement>) => {
        ...
        if (editing) {
            form.put(
                route('admin.system.search.update', {
        ...
        form.post(
            route('admin.system.search.store'),
            {
                preserveScroll: true,
            },
        )
                        ...
                        <div className="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <p className="mt-1 max-w-3xl text-sm leading-6 text-gray-500">
                                    {editing
                                        ? 'Update the stored Search profile without moving provider credentials into the Search subsystem.'
                                        : 'Prepare a reusable Search engine profile without changing the currently active Search runtime.'}
                                </p>
                            </div>
                        </div>

                        <Link
                            href={route('admin.system.search.index')}
                        ...
                        <div className="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <p className="mt-1 max-w-4xl text-sm leading-6 text-sky-800/80">
                                    Search ownership remains unchanged until the profile is explicitly activated. Activation performs structural validation and a fresh health preflight before switching managed ownership.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="space-y-6">
                        <section className="overflow-hidden rounded-[28px] border border-gray-200 bg-white shadow-sm">
                            <SectionHeader
                                icon={Search}
                                title="Profile"
                                description="Identify this managed Search profile and choose the Scout engine it delegates to."
                            />
                            ...
                            <div className="space-y-6 p-5 sm:p-6">
                                <div>
                                    ...
                                    <p className="mt-1 text-sm leading-6 text-gray-500">
                                        Use a name that clearly identifies the environment or purpose of this Search target.
                                    </p>
                                ...
                                <div>
                                    ...
                                    <p className="mt-1 text-sm leading-6 text-gray-500">
                                        The engine determines whether Search runs directly against the application database or through an external provider.
                                    </p>
                                    ...
                                    {editing ? (
                                        <div className="mt-3 flex items-start gap-2 rounded-xl border border-gray-200 bg-gray-50 px-3 py-2.5">
                                            ...
                                            <p className="text-xs leading-5 text-gray-600">
                                                The Search engine cannot be changed after profile creation. Create another profile to use a different engine.
                                            </p>
                                        </div>
                                    ) : null}
                        ...
                        {requiresInfrastructure ? (
                            <section className="overflow-hidden rounded-[28px] border border-gray-200 bg-white shadow-sm">
                                <SectionHeader
                                    ...
                                    description="Attach an enabled managed Infrastructure Connection that owns the provider endpoint and credentials."
                                />
                                ...
                                <div className="space-y-5 p-5 sm:p-6">
                                    <div>
                                        ...
                                        <p className="mt-1 text-sm leading-6 text-gray-500">
                                            Only enabled {selectedDefinition?.label ?? 'provider'} connections can be selected.
                                        </p>
                                            ...
                                            <div className="flex gap-3">
                                                ...
                                                <div>
                                                    ...
                                                    <p className="mt-1 text-sm leading-6 text-amber-800">
                                                        Create and enable a matching Infrastructure Connection before this Search profile can use the selected provider.
                                                    </p>
                            ...
                            <section className="overflow-hidden rounded-[28px] border border-gray-200 bg-white shadow-sm">
                                <SectionHeader
                                    icon={Database}
                                    title="Built-in database engine"
                                    description="This Search engine does not require a separate Infrastructure Connection."
                                />
                                        ...
                                        <div className="flex items-start gap-3">
                                            ...
                                            <div>
                                                ...
                                                <p className="mt-1 text-sm leading-6 text-emerald-800">
                                                    Laravel Scout performs database-backed searching through the application's existing database connection. No additional endpoint or API credential is stored for this profile.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <section className="overflow-hidden rounded-[28px] border border-gray-200 bg-white shadow-sm">
                            <SectionHeader
                                icon={ShieldCheck}
                                title="Availability"
                                description="Control whether this stored profile may be tested and activated."
                            />
                            ...
                            <div className="p-5 sm:p-6">
                                <button
                                    ...
                                    className="flex w-full items-center justify-between gap-6 rounded-2xl border border-gray-200 bg-gray-50/60 p-5 text-left transition hover:border-gray-300 hover:bg-gray-50"
                                >
                                    <div className="min-w-0">
                                        ...
                                        <p className="mt-1 max-w-2xl text-sm leading-6 text-gray-500">
                                            Enabled profiles may be tested and activated. Disabling a stored profile does not change Search ownership by itself.
                                        </p>
                                    </div>
                    ...
                    <aside className="space-y-4 xl:sticky xl:top-6 xl:self-start">
                        <div className="rounded-[28px] border border-gray-200 bg-white p-5 shadow-sm">
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="mt-1 text-sm leading-6 text-gray-500">
                                        Search profiles intentionally contain only Search runtime ownership information.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="mt-5 space-y-4">
                                <BoundaryItem
                                    title="Stored here"
                                    text="Profile name, Search engine, enabled state, and the optional Infrastructure Connection reference."
                                />

                                <BoundaryItem
                                    title="Stored in Infrastructure"
                                    text="Provider endpoints, application identifiers, nodes, API keys, and connection settings."
                                />

                                <BoundaryItem
                                    title="Not stored here"
                                    text="Searchable model fields, index schemas, reindex state, and business-domain search configuration."
                                />

                                <BoundaryItem
                                    title="Activation"
                                    text="Saving never changes the active Scout runtime. Ownership is switched separately from the Search page."
                                />
                            </div>
                        </div>
                        ...
                        <div className="rounded-[28px] border border-gray-200 bg-gray-50 p-5">
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    <p className="text-sm font-semibold text-gray-900">
                                        Provider secrets stay out of Search
                                    </p>

                                    <p className="mt-1 text-sm leading-6 text-gray-600">
                                        API credentials remain encrypted in Infrastructure Connections and are never copied into Search profiles or returned to this form.
                                    </p>
                                </div>
                            </div>
                        </div>
                ...
                <div className="min-w-0">
                    ...
                    {!available ? (
                        <p className="mt-2 text-xs leading-5 text-amber-700">
                            This connection is retained because the profile already references it, but it cannot be used for a new activation in its current state.
                        </p>
                    ) : null}
                </div>
            </div>
