...
class PermissionAgentReleasesSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $permissions = [
            [
                'key' => 'agent.contacts.create_release',
            ...
            [
                'key' => 'agent.contacts.view_releases',
                'label' => 'View releases',
                'type' => 'agent',
                'ui_type' => 'checkbox',
                'sort_order' => 20,
            ...
            [
                'key' => 'agent.contacts.edit_release',
                'label' => 'Edit release',
                'type' => 'agent',
                'ui_type' => 'checkbox',
                'parent_key' => 'agent.contacts.view_releases',
                'sort_order' => 30,
            ],
            [
                'key' => 'agent.contacts.mark_complete',
            ...
            [
                'key' => 'agent.contacts.delete_release',
            ...
            [
                'key' => 'agent.contacts.attach_detach_releases',
                'label' => 'Attach or detach the releases',
                'type' => 'agent',
                'ui_type' => 'checkbox',
                'sort_order' => 80,
            ],
