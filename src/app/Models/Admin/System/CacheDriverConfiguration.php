...
class CacheDriverConfiguration extends Model
{
    ...
    {
        return ['driver' => CacheDriverType::class, 'configuration' => 'array', 'is_enabled' => 'boolean'];
    }
    ...
    {
        return $this->hasMany(CacheDriverHealthCheck::class);
    }

    public function latestHealthCheck(): HasOne
    {
        return $this->hasOne(CacheDriverHealthCheck::class)->latestOfMany();
    }
}
