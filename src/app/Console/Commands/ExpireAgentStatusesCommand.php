...
class ExpireAgentStatusesCommand extends Command
{
    ...
    public function handle(AgentStatusExpirationService $service): int
    {
        $r = $service->expireDueStatuses();
        $this->info("Found: {$r['found']}; expired: {$r['expired']}; skipped: {$r['skipped']}; errors: {$r['errors']}.");
