...
return [
    ...
    'agents_list' => [
        ...
        'show_by' => 'Show by:',
        'deactivate_chosen' => 'Deactivate Selected',
        'enter_text_press_enter' => 'Enter text and press Enter to search...',
        'deactivate_agents' => 'Deactivate Agents',
        'choose_action_for_created_tickets' => 'Choose what should happen to tickets created by the Agent',
        'close_all_open_tickets' => 'Close all open tickets',
        'change_assignee' => 'Change assignee',
        'reassign_to_agent' => 'Reassign to agent:',
        'select_agent' => '-- Select an agent --',
        'choose_action_for_assigned_tickets' => 'Choose what should be done with tickets assigned to the Agent',
    ...
    'agents_form' => [
        ...
        'first_name_error' => 'This field cannot be empty',
        'patronymic' => 'Patronymic',
        'patronymic_placeholder' => 'Enter patronymic',
        'location' => 'Select Location',
        'location_placeholder' => 'Enter a value to search',
        'phone_number' => 'Phone Number',
        'mobile_phone' => 'Mobile Phone',
        'internal_number' => 'Enter Internal Number',
        'internal_number_placeholder' => '123-456',
        'timezone' => 'Enter Timezone',
        'account_status_settings' => 'Account Status and Settings',
        'department' => 'Department',
