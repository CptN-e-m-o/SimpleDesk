...
return [
    ...
    'sections' => [
        ...
        'attachment_scanner' => 'Сканер вложений',
        'additional_configs' => 'Дополнительные конфигурации',
    ],
    ...
    'email' => [
        'settings' => 'Настройки почты',
        'breaklines' => 'Линии разрыва',
        'diagnostics' => 'Диагностика',
        'oauth' => 'Интеграция OAuth',
    ],
    'drivers' => [
        'queues' => 'Очереди',
        'cache' => 'Драйверы кэша',
    ...
    'tickets' => [
        ...
        'labels' => 'Ярлыки',
        'ratings' => 'Оценки',
        'workflow' => 'Рабочий процесс заявки',
        'tags' => 'Теги',
        'auto_assignment' => 'Автоматическое назначение',
        'source' => 'Источник',
        'recurring' => 'Повторяющийся',
        'location' => 'Местоположение',
        'template' => 'Шаблон заявки',
        'pdf_template' => 'Шаблон заявки в PDF',
    ],
    'settings' => [
        'company' => 'Компания',
        'system' => 'Система',
        ...
        'social_widget' => 'Настройки социального виджета',
        'webhook' => 'Вебхук',
        'user_import' => 'Импорт пользователя',
        'recaptcha' => 'Рекапча',
        'login_log' => 'Настройки журнала входа',
        'customer_filter' => 'Фильтр клиентов',
    ],
    'addons' => [
        'plugins' => 'Плагины',
        'modules' => 'Модули',
    ...
    'developer' => [
        ...
        'saml_integration' => 'Интеграция SAML 2.0',
        'personal_access_tokens' => 'Личные токены доступа',
        'oauth_app' => 'Приложение OAuth',
        'iframe_injection' => 'Инъекция Iframe',
    ],
    'notifications' => [
        'template_management' => 'Управление шаблонами',
        'notification_management' => 'Управление уведомлениями',
        'in_app_log' => 'Управление журнала в приложении',
    ],
    'billing' => [
        'options' => 'Опции',
        'package' => 'Пакет',
    ...
    'health_check' => [
        'check' => 'Проверка здоровья',
        'alerts' => 'Оповещения проверки работоспособности',
        'debug_options' => 'Опции отладки',
        'system_logs' => 'Системные журналы',
        'activity_logs' => 'Журналы активности системного уровня',
    ],
    'attachment_scanner' => [
        'scanner_list' => 'Список сканеров',
    ],
    'additional_configs' => [
