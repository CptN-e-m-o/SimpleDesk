...
return [
    ...
    'agents_list' => [
        ...
        'deactivate_chosen' => 'Деактивировать выбранных',
        'enter_text_press_enter' => 'Введите текст и нажмите Enter для поиска...',
        'deactivate_agents' => 'Деактивировать агентов',
        'choose_action_for_created_tickets' => 'Выберите что должно произойти с заявками, созданными Агентом',
        'close_all_open_tickets' => 'Закрыть все открытые заявки',
        'change_assignee' => 'Сменить назначенного',
        'reassign_to_agent' => 'Переназначить агенту:',
        'select_agent' => '-- Выберите агента --',
        'choose_action_for_assigned_tickets' => 'Выберите что нужно сделать с заявками, назначенными Агенту',
        'unassign_all_open_tickets' => 'Снять назначение со всех открытых заявок',
        'close' => 'Закрыть',
        ...
        'edit' => 'Редактировать',
        'view' => 'Просмотр',
        'view_as_agent' => 'Посмотреть как агент',
        'view_as_user' => 'Посмотреть как пользователь',
        'email_verified' => 'Email',
        'phone_verified' => 'Телефон',
        'two_factor' => '2FA',
    ],
    // Agents create/edit form
    'agents_form' => [
        'create_agent' => 'Создать агента',
        ...
        'email_error' => 'Введите настоящий адрес e-mail',
        'login' => 'Логин',
        ...
        'first_name_error' => 'Это поле не может быть пустым',
        'patronymic' => 'Отчество',
        'patronymic_placeholder' => 'Введите отчество',
        'location' => 'Выберите местоположение',
        'location_placeholder' => 'Введите значение для поиска',
        'phone_number' => 'Телефонный номер',
        'mobile_phone' => 'Мобильный телефон',
        'internal_number' => 'Введите внутренний номер',
        'internal_number_placeholder' => '123-456',
        'timezone' => 'Введите часовой пояс',
        'account_status_settings' => 'Статус аккаунта и настройки',
        'department' => 'Отдел',
        'department_placeholder' => 'Выберите отдел',
        'team' => 'Команда',
        'team_placeholder' => 'Выберите команду',
        'type' => 'Тип',
    ...
    'teams_form' => [
        ...
        'save' => 'Сохранить',
        'name' => 'Название',
        'name_placeholder' => 'Введите значение',
